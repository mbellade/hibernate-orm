 ...
 * <ul>
 *   <li>{@code transactionId(e)} &ndash; returns the transaction identifier
 *   <li>{@code modificationType(e)} &ndash; returns the modification type ordinal
 * </ul>
	...
	private static class AuditColumnSqmFunction<T> extends SelfRenderingSqmFunction<T> {
		...
		public Expression convertToSqlAst(SqmToSqlAstConverter walker) {
			...
			final SelectableMapping selectableMapping = transactionId
					...
					: auditMapping.getModificationTypeMapping();
