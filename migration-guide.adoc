...
Previously, all identifiers were always sent to the database regardless of session state. The new default avoids
redundant database queries and is consistent with the behavior of single-entity `Session#find()`.
